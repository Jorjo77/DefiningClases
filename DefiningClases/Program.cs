...
namespace DefiningClases
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Ако от 8ч. работен ден направиш 4 ч. писане на код си машина!!!
            //Koгато прекаляваш с програмиране може да се окажеш в ситуация да не можеш да се изключиш да си починеш, което става вредно и се отразява на здравето. Масиво 4-6  часа на ден се програмира и това е нормално и шефовете го разбират.
            //C#, JS, HTML and CSS са ни напълно достатъчни за да започнем кариера.. От там език дтуг ако се налага се учи за 1 седмица. Да учим финдаментални неща - алгуритми, бази данни, компютър саянс... 
